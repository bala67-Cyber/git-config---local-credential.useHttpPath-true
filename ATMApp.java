...
public class ATMApp {
    ...
    public static void main(String[] args) {
        ...
        Account account = new SavingAccount("SA-1001", "Juan Dela Cruz", 5000.0, 0.02);
            ...
            try {
                ...
                switch (choice) {
                    ...
                    case 3:
                        ...
                        System.out.printf("Withdrew PHP %.2f. New balance: PHP %.2f%n", withAmount, account.getBalance());
                        break;
                    case 4:
                        double totalDeposited = atm.depositAll(account, 100, 250.5, 300);
                        System.out.printf("Deposited multiple amounts total: PHP %.2f. New balance: PHP %.2f%n",
                    ...
                    case 5:
                        ...
                        System.out.printf("Balance after addBonus (PHP 50.00 added): PHP %.2f%n", account.getBalance());
                        break;
                    case 0:
                        running = false;
                        break;
